...
import matplotlib
matplotlib.use('TkAgg') # http://www.davidketcheson.info/2015/01/13/using_matplotlib_image_comparison.html
...
class Box(object):
    ...
    def plot(self,scaled_rad=None,clamp_edge=0.0):
        ...
        print("in -1 to 1 square,the radius is: {:04.2f}".format(rad/scaled_box[1]*2))
